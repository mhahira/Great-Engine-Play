...
import Reto_3.Modelo.Ortopedia;
import Reto_3.Servicios.ServiciosOrtopedia;
...
public class OrtopediaWeb {
    ...
    public boolean delete(@PathVariable("id") int ortopediaId) {
        return servicio.deleteOrtopedia(ortopediaId);
    }
}
